Public Interface iFileFormat
    Inherits SkyCD.ISkyCDPlugIn

    Function IsSupported(ByVal Filename As String) As Boolean

    Function GetSupportedFileFormats() As Collection

    Sub Load(ByVal FileName As String)
    Sub Save(ByVal FileName As String)

    Property Database() As System.Data.OleDb.OleDbDataAdapter
    ...
    Structure scdFileFormatsItem
        Dim scdExtentions As Collection
